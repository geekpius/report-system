...
class ListPendingClassMarkAction
{
    use ApiResponse;
    ...
    public function handle(ListMarkEntryRequest $request, School $school): JsonResponse
    {
        return $this->success(
            MarkEntryResource::collection(
                (new MarkEntryQuery)->get($request, $school, MarkEntryKind::ClassScore, recorded: false),
            ),
            'Pending class marks retrieved successfully.',
        );
    }
}
